...
#ifndef MORE_CPP_LINQ_SELECT_HPP
#define MORE_CPP_LINQ_SELECT_HPP
...
namespace more
{
	...
	public:
		...
		public:
			...
			enumerator(const source_enumerator& source, const function& selector) :
		...
		select_expression(const source_expression& source, const function& selector) :
			source(source), selector(selector)
		{
...
#endif//MORE_CPP_LINQ_SELECT_HPP